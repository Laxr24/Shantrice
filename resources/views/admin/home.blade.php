...
@section('content')
    <div class="container my-6 md:max-w-lg bg-gray-100 shadow-lg py-2 px-2 mx-auto">
        ...
        <form action="{{ route('admin-update')}}" method="post">
            ...
            <textarea  name="meta-description"  placeholder="Meta description" class="w-full rounded p-2 my-2 font-mono outline-none" id="">{{ $config['meta-description'] }}</textarea>
        ...
        <textarea  name="content"  placeholder="Content" class="w-full rounded p-2 my-2 font-mono outline-none" id="">{{ $home['content']}}</textarea>
